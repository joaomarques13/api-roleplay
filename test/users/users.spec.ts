...
test.group('User', (group) => {
  ...
  test('it should return 409 when email ir already in use', async (assert) => {
  ...
  test('it should return 409 when username ir already in use', async (assert) => {
  ...
  test('it should return 422 when password or email are not valid', async (assert) => {
    const { body } = await supertest(BASE_URL)
      .post('/users')
      .send({
        email: 'test@',
  ...
  test('it should update and user', async (assert) => {
    const email = 'test@test.com'
    const avatar = 'https://github.com/joaomarques13.png'
